...
public class FormTambahProduk extends JDialog {
    ...
    public FormTambahProduk(TampilanMenu parent) {
    ...
    private void saveProduct() {
        ...
        try {
            ...
            // Copy image to src/resources/images/
            ...
            try (Connection conn = DatabaseConnection.getConnection();
                 PreparedStatement stmt = conn.prepareStatement(
                     "INSERT INTO produk (nama_produk, harga, stok, image_path) VALUES (?, ?, ?, ?)")) {
                ...
                stmt.executeUpdate();
                parent.refreshTable();
                JOptionPane.showMessageDialog(this, "Produk ditambahkan!", "Success", JOptionPane.INFORMATION_MESSAGE);
                dispose();
            }
